            ...
            constructor: l, init: function () {
                ...
                return l.each(function (b) {
                    ...
                    if (g++, !f.hasClass("bs-title-option")) {
                        var k, m = this.className || "", n = j(this.style.cssText),
                        ...
                        } else if (!0 === f.data("divider")) d.push(h("", b, "divider")); else if (!0 === f.data("hidden")) k = f.data("prevHiddenIndex"), f.next().data("prevHiddenIndex", void 0 !== k ? k : b), d.push(h(i(o, m, n, p), b, "hidden is-hidden")); else {
